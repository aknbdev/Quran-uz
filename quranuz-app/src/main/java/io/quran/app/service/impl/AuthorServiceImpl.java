...
public class AuthorServiceImpl implements AuthorService {
    ...
    @Override
    public List<AuthorDto> findAllInterpreters() {

        return findAllAuthorsByType(AuthorType.INTERPRETER)
                .stream()
    ...
    @Override
    public List<AuthorDto> findAllReciters() {

        return findAllAuthorsByType(AuthorType.RECITER)
                .stream()
                .map(authorMapper::toAuthorDto)
                .collect(Collectors.toList());
    }
